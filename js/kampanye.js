...
function changeBentengBg(){

heritageBg.style.backgroundImage =
`url('${bentengImages[bentengIndex]}')`;

bentengIndex++;

if(bentengIndex >= bentengImages.length){
bentengIndex = 0;
}
...
/* ganti tiap 6 detik */
setInterval(changeBentengBg, 6000);